...
import ReviewClassCardUser from "../../../../../Components/ContentContainer/ReviewClassCardUser";
...
const ReviewWriteUser = ({ history, title: headerTitle }) => {
...
export default withRouter(ReviewWriteUser);
